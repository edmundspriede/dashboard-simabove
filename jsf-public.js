(() => {
    ...
    (() => {
                            ...
                            (function (e) {
                                ...
                                (function (e, r) {
                                    if (e) {
                                        ...
                                        return (
                                            "Object" === i && e.constructor && (i = e.constructor.name), "Map" === i || "Set" === i ? Array.from(e) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? t(e, r) : void 0
                                        );
                                    }
                                })(i) ||
                                (function () {
                    ...
                    if (null != r) {
                        ...
                        try {
                            if (((o = (r = r.call(t)).next), 0 === e)) {
                                ...
                                l = !1;
                            } else for (; !(l = (i = o.call(r)).done) && (s.push(i.value), s.length !== e); l = !0);
                        } catch (t) {
                            (u = !0), (n = t);
                        } finally {
                            try {
        ...
        function p(t, e) {
            ...
            if ("[object Array]" === r) {
                for (var o = 0; o < i; o++) if (!1 === n(t[o], e[o])) return !1;
            } else for (var a in t) if (t.hasOwnProperty(a) && !1 === n(t[a], e[a])) return !1;
            return !0;
        }
        function h(t) {
                    ...
                    (t = function t(r) {
                        ...
                        !(function (t, e) {
                            ...
                            e.subscribe(
                                "ajaxFilters/updated",
                                function (t, e) {
                                    i.filterGroup.isCurrentProvider({ provider: t, queryId: e }) && (i.filterGroup.additionalRequest = !1);
                                },
                                !0
                            );
                    }),
        ...
        function I(t, e, r) {
            return e && $(t.prototype, e), r && $(t, r), Object.defineProperty(t, "prototype", { writable: !1 }), t;
        }
        function F(t) {
            var e = (function (t) {
                ...
                C(document).on("jet-engine-request-calendar", function () {
                    ...
                    if (t && "jet-engine-calendar" === r.filterGroup.provider) {
                        ...
                        2 === i.length &&
                            ...
                            ((window.JetSmartFilterSettings.settings[r.filterGroup.provider][r.filterGroup.queryId].custom_start_from = !0),
        ...
        function R(t, e, r) {
            return (e = A(e)) in t ? Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : (t[e] = r), t;
        }
        function A(t) {
            var e = (function (t) {
                        ...
                        if (
                            ...
                            e.subscribe("fiter/apply", function (t) {
                                ...
                                e.subscribe("ajaxFilters/updated", function (t, e) {
                                    i.filter.isCurrentProvider({ provider: t, queryId: e }) && ("never" === i.changeCounte || ("other_changed" === i.changeCounte && n) || ((n = !0), i.update()));
                                }),
                    ...
                    (r = [
                                ...
                                e.each(function (r) {
                                    ...
                                    if (n.val()) {
                                        ...
                                        ["hide", "disable"].includes(t.indexerRule) &&
                                            (o || t.hasNonEmptyNestedItems(n)
                                                ? (n.removeClass("jet-filter-row-" + t.indexerRule),
                                                  "OPTION" === n.prop("tagName") && "hide" === t.indexerRule && n.parent("span.jet-filter-row-hide").length && n.unwrap(),
                                                  "OPTION" === n.prop("tagName") && "disable" === t.indexerRule && n.removeAttr("disabled"))
                                                : (n.addClass("jet-filter-row-" + t.indexerRule),
                                    ...
                                    "hide" === this.indexerRule &&
                                        (!this.filter.isHierarchy || (this.filter.isHierarchy && 0 === this.filter.depth)
                                            ? i >= r
                                                ? (this.filter.$container.hide(), this.filter.$applyButton.hide())
                                                : (this.filter.$container.show(), this.filter.$applyButton.show())
                                            : i >= r
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                p(t, this.currentIndexerData) || ((this.currentIndexerData = t), this.set());
                            },
                        },
                        {
                            key: "updateFilter",
                            ...
                            get: function () {
                                ...
                                for (var r in t)
                                    if (r === this.filter.provider + "/" + this.filter.queryId)
                                        for (var i in t[r]) if (i === this.filter.queryType) for (var n in t[r][i]) if (n === this.filter.queryVar) for (var o in t[r][i][n]) e[o] = t[r][i][n][o];
                                return e;
                            },
                        },
                        {
                            ...
                            value: function (t) {
                                var e = !1;
                                if (!t.hasClass("jet-list-tree__parent")) return e;
                                var r = t.next(".jet-list-tree__children");
                                if (!r.length) return e;
                                var i = this.currentIndexerData;
                                return (
                                    r.find("input.jet-checkboxes-list__input").each(function (t, r) {
                                        if (i[r.value]) return (e = !0), !1;
                                    }),
                                    e
                                );
                            },
                ...
                (r = [
                    {
                        ...
                        value: function (t) {
                            t.keypress(function (t) {
                                t.preventDefault(), 13 === t.keyCode && B(t.target).trigger("click");
                            });
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.filter.$filter.find("[tabindex]").keypress(function (t) {
                                t.preventDefault(), B(t.target).prev("input").trigger("click");
                            });
                        },
                    },
                    {
                            ...
                            this.filter.$filter.find("[tabindex]").keydown(function (e) {
                                if ([13, 32, 37, 38, 39, 40].includes(e.keyCode)) {
                                    ...
                                    [37, 38, 39, 40].includes(e.keyCode) &&
                                        ([37, 40].includes(e.keyCode) && r.val(parseFloat(r.val()) - parseFloat(r.attr("step"))),
                            ...
                            if (this.filter.indexer && "disable" === this.filter.indexer.indexerRule) {
                                ...
                                r(),
                                    e.subscribe("ajaxFilters/updated", function (e, i) {
                                        t.filter.isCurrentProvider({ provider: e, queryId: i }) && r();
                                    });
                            }
                        },
                    },
                ...
                (e = [
                        ...
                        value: function () {
                            this.filterGroup.$provider.addClass(this.containerLoadingClass),
                                this.preloaderTemplate &&
                                    ("bricks-query-loop" === this.filterGroup.provider
                                        ? ((this.$container = this.filterGroup.$provider.first().append(this.preloaderTemplate)), (this.$preloader = this.filterGroup.$provider.first().find(">.".concat(this.preloaderClass))))
                                        : ((this.$container = this.filterGroup.$provider.append(this.preloaderTemplate)), (this.$preloader = this.filterGroup.$provider.find(">.".concat(this.preloaderClass)))),
                                    this.fixedPosition && (this.handleEvent(), window.addEventListener("scroll", this), window.addEventListener("resize", this)));
                        },
                    },
                    {
                        key: "hide",
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            s > 0 && l > 0
                                ? this.$preloader.css({ position: "fixed", top: "".concat(a, "px"), left: "".concat(r + n / 2, "px") })
                                : this.$preloader.css({ position: "absolute", top: "".concat(e >= 0 ? this.fixedEdgeGap : i - o - this.fixedEdgeGap, "px"), left: "50%" });
                        },
                    },
                ]) && J(t.prototype, e),
                Object.defineProperty(t, "prototype", { writable: !1 }),
                                ...
                                this.filters.forEach(function (i) {
                                    if (!t.setted[i.filterId]) {
                                        ...
                                        if (((t.setted[i.filterId] = o), n != o)) {
                                            var a = o;
                                            if (
                                                (["checkboxes", "check-range", "alphabet", "visual"].includes(i.name) &&
                                                    a.indexOf(",") > -1 &&
                                                ...
                                                if (
                                                    !(
                                                        ["checkboxes", "check-range"].includes(i.name) ||
                                                        ("alphabet" === i.name && "checkbox" === i.$checkboxes.first().attr("type")) ||
                                                        ("visual" === i.name && "checkbox" === i.$checkboxes.first().attr("type"))
                                                    )
                                                )
                                                    return;
                                                a = l(n, a);
                                            }
                                            "select" === i.name && i.isHierarchy
                                                ? i.hierarchicalInstance.setData(
                                                      a.split("-").map(function (t) {
                                                          return t.trim();
                                                      })
                                                  )
                                                : (i.setData(a), i.wasChanged(!1)),
                                        ...
                                        setTimeout(function () {
                                            ...
                                            r.forEach(function (e) {
                                                e.additionalProviders.forEach(function (r) {
                                                    ...
                                                    i &&
                                                        i.additionalFilters.updateAdditionalFilterByParent(e) &&
                                                        t.every(function (t) {
        ...
        const tt = {
            ...
            ajax: function (t) {
                ...
                return new Promise(function (r, i) {
                    ...
                    if (
                        ...
                        m && (g = m),
                            p && Object.assign(n, p),
                            (e.xhrs[u + "/" + c] = X.ajax({ url: g, type: "POST", dataType: "json", data: n })
                                .done(function (t) {
                                    r(t);
                                })
                                .fail(function (t, e) {
            ...
            redirectWithGET: function (t, e) {
                ...
                if (e) {
                    ...
                    f(i) || (i = d(JetSmartFilterSettings, "siteurl") + i), window.open(i, r ? "_blank" : "_top");
                }
            },
                    ...
                    r && i.attr("target", "_blank"),
                        ...
                        X.each(t, function (t, e) {
                            Array.isArray(e)
                                ...
                                : ("object" === Z(e) && null !== e && (e = JSON.stringify(e)), i.append(n(t, e)));
                        }),
                ...
                return (
                    ...
                    (r = [
                        ...
                        },
                        {
                            key: "processFilters",
                            value: function () {
                                this.filters.length && ((this.currentQuery = this.query), this.setFiltersData(), this.additionalFilters.updateProvider(), this.predefinedData.set(), this.emitFiltersProcessed());
                            },
                        },
                        {
                            key: "reinitFilters",
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.doAjax({ append: !0, autoscroll: t });
                            },
                        },
                        {
                            key: "apply",
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                var r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
                                if ("reload" === t) tt.redirectWithGET(this.getUrl(!0), e, r);
                                else {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t = this.getUrl(!0),
                                    e = this.baseUrl;
                                t && (e = S(this.baseUrl + t)), (document.location = e);
                            },
                        },
                        {
                            key: "doAjax",
                        ...
                        },
                        {
                            ...
                            value: function () {
                                (this.isAjaxLoading = !0), this.providerPreloader.show(), e.publish("ajaxFilters/start-loading", this.provider, this.queryId);
                            },
                        },
                        {
                            key: "endAjaxLoading",
                            value: function () {
                                (this.isAjaxLoading = !1), this.providerPreloader.hide(), e.publish("ajaxFilters/end-loading", this.provider, this.queryId);
                            },
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                if (
                                    (t.pagination && d(JetSmartFilterSettings, "props", this.provider, this.queryId) && (window.JetSmartFilterSettings.props[this.provider][this.queryId] = at({}, t.pagination)),
                                    t.jetFiltersIndexedData &&
                                        d(JetSmartFilterSettings, "jetFiltersIndexedData", this.providerKey) &&
                                        (window.JetSmartFilterSettings.jetFiltersIndexedData[this.providerKey] = t.jetFiltersIndexedData[this.providerKey]),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                if (this.$provider.length) {
                                    if ((et(document).find(this.$provider).length || (this.$provider = this.getProvider()), r.append)) {
                                        var i = this.$provider,
                                            n = !1;
                                        if ((this.providerSelectorData.list && (i = i.find(this.providerSelectorData.list).not(this.providerSelectorData.list + " " + this.providerSelectorData.list)), this.providerSelectorData.item))
                                            n = et(t)
                                            ...
                                            n = et('<div class="container">' + t + "</div>")
                                                .find(o)
                                                .not(o + " " + o)
                                                .children();
                                        }
                                        if (r.autoscroll || 0 === r.autoscroll) {
                                            ...
                                            et("html, body")
                                                .stop()
                                                .animate({ scrollTop: i.offset().top + i.outerHeight(!0) - a }, 500);
                                        }
                                        i.append(n);
                                    } else
                                        "insert" === this.providerSelectorData.action
                                            ? ("epro-portfolio" === this.provider && (t = et(t).children().children()), this.$provider.html(t))
                                            : (this.$provider.replaceWith(t), (this.$provider = this.getProvider()));
                                    if (window.elementorFrontend) {
                                        ...
                                        this.$provider.find("[data-element_type]").each(function (t, e) {
                                            ...
                                            "widget" === i && ((i = r.data("widget_type")), window.elementorFrontend.hooks.doAction("frontend/element_ready/widget", r, et)),
                                    ...
                                    window.bricksIsFrontend && ["jet-engine", "jet-engine-calendar"].includes(this.provider) && document.dispatchEvent(new CustomEvent("bricks/ajax/query_result/displayed")),
                                        window.JetPlugins &&
                                            (window.JetPlugins.init(this.$provider), this.$provider.closest('[data-is-block*="/"]').length && window.JetPlugins.initBlock(this.$provider.closest('[data-is-block*="/"]')[0], !0)),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                            ...
                                            if (i) {
                                                ...
                                                switch (r.name) {
                                                    ...
                                                    case "pagination":
                                                        ...
                                                        break;
                                                    case "search":
                                                        "meta_query" === r.queryType && ((n = "_sm"), (o = !1), (i = r.queryVar + "!" + i));
                                                        break;
                                                    default:
                                                    ...
                                                    (function (t, e, r) {
                                                        ...
                                                        if (t)
                                                            for (var n = e, o = 0; o < r.length; o++) {
                                                                var a = r[o];
                                                                o === r.length - 1 ? (n[a] && i.merge ? (n[a] = l(n[a], t)) : (n[a] = t)) : (n[a] || (n[a] = {}), (n = n[a]));
                                                            }
                                                    })(i, e, u, { merge: r.mergeSameQueryKeys });
                                            }
                                        }
                                    }),
                                    c(e))
                                ...
                                if ((this.queryId && "default" !== this.queryId && (i += ":" + this.queryId), "permalink" === this.urlType)) {
                                    for (var n in ((r = this.urlPrefix + "/" + i + "/"), "_s" in e && ((e.search = e._s), delete e._s), "_sm" in e && ((e["search-by-meta"] = e._sm), delete e._sm), e)) {
                                        var o = e[n];
                                        if (((r += n + "/"), s(o))) {
                                            if (Array.isArray(o)) r += encodeURIComponent(o.join()) + "/";
                                            else for (var a in o) r += a + ":" + encodeURIComponent(o[a]) + ";";
                                            r = r.replace(/;\s*$/, "/");
                                        } else r += encodeURIComponent(o) + "/";
                                    }
                                    this.baseUrlParams && (r += this.baseUrlParams);
                                } else
                                    for (var u in ((r = this.baseUrlParams ? this.baseUrlParams + "&" + this.urlPrefix + "=" + i : "?" + this.urlPrefix + "=" + i), e)) {
                                        var f = e[u];
                                        if (((r += "&" + u + "="), s(f))) {
                                            if (Array.isArray(f)) r += encodeURIComponent(f.join());
                                            else for (var p in f) r += p + ":" + encodeURIComponent(f[p]) + ";";
                                            r = r.replace(/;\s*$/, "");
                                        } else r += encodeURIComponent(f);
                                    }
                                return r;
                            },
                        },
        ...
        function pt(t, e) {
            for (var r = 0; r < e.length; r++) {
                var i = e[r];
                (i.enumerable = i.enumerable || !1), (i.configurable = !0), "value" in i && (i.writable = !0), Object.defineProperty(t, yt(i.key), i);
            }
        }
        function ht(t, e, r) {
            return (e = yt(e)) in t ? Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : (t[e] = r), t;
        }
        function yt(t) {
            var e = (function (t) {
                ...
                return (
                    (t = function t(e) {
                        ...
                        !(function (t, e) {
                            ...
                            this.$container &&
                                (this.$container.next(this.applySelector).length
                                    ? (this.$applyButton = this.$container.next(this.applySelector).find(this.applyButtonSelector))
                                    : this.$container.closest(this.filtersGroupSelector).length && (this.$applyButton = this.$container.closest(this.filtersGroupSelector).next(this.applySelector).find(this.applyButtonSelector))),
                    ...
                    (r = [
                        {
                            key: "initEvent",
                            value: function () {
                                this.addFilterChangeEvent(), this.applyOnChanging || this.addApplyEvent();
                            },
                        },
                        {
                            key: "removeEvent",
        ...
        function wt(t, e) {
            for (var r = 0; r < e.length; r++) {
                var i = e[r];
                (i.enumerable = i.enumerable || !1), (i.configurable = !0), "value" in i && (i.writable = !0), Object.defineProperty(t, St(i.key), i);
            }
        }
        function St(t) {
            var e = (function (t) {
			 ...
			 value: function () {
                        ...
                        },
                        {
                            ...
                            get: function () {
                                var t = this,
                                    e = this.data;
                                if (!e || !this.isUrlValAvailable) return e;
                                var r = e;
                                return (
                                    Array.isArray(e)
                                        ? ((r = []),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                (i || r) &&
                                    (r &&
                                        (e.parents(".jet-list-tree__children").prev(".jet-list-tree__parent").find(".jet-checkboxes-list__input").prop("checked", !1),
        ...
        function xt(t, e) {
            for (var r = 0; r < e.length; r++) {
                var i = e[r];
                (i.enumerable = i.enumerable || !1), (i.configurable = !0), "value" in i && (i.writable = !0), Object.defineProperty(t, $t(i.key), i);
            }
        }
        function $t(t) {
            var e = (function (t) {
                ...
                return (
                    ...
                    (e = [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                (this.$dropdownLabel = this.$dropdown.find(".".concat(this.dropdownClass, "__label"))),
                                    ...
                                    this.dropdownApplyButton.length &&
                                        this.dropdownApplyButton.on("click", function () {
                                            var e;
                                            t.filter.processData(),
                        ...
                        },
                        {
                            key: "dropdownClose",
                            value: function () {
                                (this.dropdownState = !1), this.$dropdown.removeClass(this.dropdownOpenClass), this.$dropdown.removeClass(this.dropdownBodyPositionTopClass);
                            },
                        },
                        {
                            key: "dropdownOpen",
        ...
        function Tt(t, e, r) {
            return e && Dt(t.prototype, e), r && Dt(t, r), Object.defineProperty(t, "prototype", { writable: !1 }), t;
        }
        function Rt(t) {
            var e = (function (t) {
            ...
            !(function (t, e) {
                ...
                e.$container.find("." + this.settings.collapsibleElementClass + " ." + this.settings.toggleElementClass).each(function (t, e) {
                    ...
                    if (n.hasClass(r.settings.contentElementClass)) {
                        r.collapsibleLists.push({ $toggle: i, $content: n });
                        var o = !!n.find("input:checked").length;
                        r.settings.collapsed && !o
                            ? (i.addClass(r.settings.toggleCollapsedClass), n.addClass(r.settings.contentCollapsedClass).slideUp(0))
                            : (i.removeClass(r.settings.toggleCollapsedClass), n.removeClass(r.settings.contentCollapsedClass).slideDown(0)),
                            i.click(function (t) {
        ...
        var Mt = (function (t) {
            function e(t) {
                ...
                return (
                    ...
                    (i = r),
                    (o = "checkboxes"),
                    (n = Lt((n = "name"))) in i ? Object.defineProperty(i, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (i[n] = o),
        ...
        var Wt = (function (t) {
                function e(t) {
                    ...
                    return (
                        ...
                        (i = r),
                        (o = "check-range"),
                        (n = Kt((n = "name"))) in i ? Object.defineProperty(i, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (i[n] = o),
                ...
                return (
                    (function (t, e) {
                        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                        (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), Object.defineProperty(t, "prototype", { writable: !1 }), e && Ht(t, e);
                    })(e, t),
                    (r = e),
                    Object.defineProperty(r, "prototype", { writable: !1 }),
                    r
                ...
                (i = [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return (
                                this.isSelect
                                    ? this.$select.find("option").each(function (r, i) {
                                          var n = Qt(i);
                                          n.val() === t && (e = n);
                                      })
        ...
        var ue = (function (t) {
                function e(t) {
                    ...
                    return (
                        ...
                        (i = r),
                        (o = "select"),
                        (n = le((n = "name"))) in i ? Object.defineProperty(i, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (i[n] = o),
                        (r.mergeSameQueryKeys = !0),
                        r
                    );
                }
                                ...
                                for (var r = 1; r < i.count; r++) {
                                    var n = i.filters[r],
                                        o = ce(e["level_" + r])
                                            .find("select")
                                            .html();
                                    o && (n.$select.html(o), i.updateFilterIndexer(n));
                                }
                        }),
                        setTimeout(function () {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var t = this,
                                ...
                                i = null;
                            this.filters.forEach(function (t) {
                                t.dataValue && (null === i && (i = t.layoutOptions || !1), r.push({ value: t.data, tax: t.queryVar }), t.showPreloader());
                            }),
                    ...
                    },
                    {
                        ...
                        value: function (t, r) {
                            var i = this,
                                ...
                                u = t.args,
                                c = void 0 !== u && u,
                                f = { action: "jet_smart_filters_get_hierarchy_level", filter_id: this.filterId, values: n };
                            a && (f.depth = a),
                                l && (f.indexer = l),
                                c && (f.args = c),
                                ce
                                    ...
                                    .done(function (t) {
                                        e.publish("hierarchyFilters/updateLevels", i, t.data), "function" == typeof r && r(), e.publish("hierarchyFilters/levelsUpdated", i.filterId);
                                    })
                                    .always(function () {
                                        i.filters.forEach(function (t) {
                                            t.hidePreloader();
        ...
        var xe = (function (t) {
                function e(t) {
                    ...
                    return (
                        ...
                        (i = r),
                        (o = "range"),
                        (n = Ce((n = "name"))) in i ? Object.defineProperty(i, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (i[n] = o),
                        r
                    );
                }
                return (
                    (function (t, e) {
                        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                        (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), Object.defineProperty(t, "prototype", { writable: !1 }), e && _e(t, e);
                    })(e, t),
                    (r = e),
                    Object.defineProperty(r, "prototype", { writable: !1 }),
                    r
                ...
                (function (t) {
                    function e(t, r, i, n, o, a, s, l, u, c, f) {
                        ...
                        return (
                            ...
                            (d.format = d.$filter.data("format") || { thousands_sep: "", decimal_sep: "", decimal_num: 0 }),
                    ...
                    return (
                        (function (t, e) {
                            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                            (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), Object.defineProperty(t, "prototype", { writable: !1 }), e && je(t, e);
                        })(e, t),
                        (r = e),
                        (i = [
                            {
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    if ((this.reset(), t)) {
                                        var e = t.split("_");
                                        e[0] && ((this.minVal = parseFloat(e[0])), this.$sliderInputMin.val(this.minVal)),
                                            e[1] && ((this.maxVal = parseFloat(e[1])), this.$sliderInputMax.val(this.maxVal)),
                                            this.valuesUpdated(),
                                            this.processData();
                                    }
                                },
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    var e = !1;
                                    if (("mousemove" === t.type && (e = t.clientX), "touchstart" === t.type && t.touches[0] && (e = t.touches[0].clientX), e)) {
                                        ...
                                        (this.isRTL ? (this.minConstraint - this.maxConstraint) * (r / i) + this.maxConstraint : (this.maxConstraint - this.minConstraint) * (r / i) + this.minConstraint) > o
                                            ? this.swapInput("max")
                                            : this.swapInput("min");
                                    }
                                },
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    this.$sliderTrackRange.css({ "--low": t + "%", "--high": e + "%" });
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    return "number" == typeof t
                                        ? t
                                        : (this.format.thousands_sep && (t = t.replace(new RegExp("\\" + this.format.thousands_sep, "g"), "")),
                                ...
                                get: function () {
                                    if ("string" == typeof this.dataValue) {
                                        var t = this.dataValue.split("_"),
                                            e = "";
                                        return (
                                            t[0] && (this.prefix && (e += this.prefix), (e += this.getFormattedData(parseFloat(t[0]))), this.suffix && (e += this.suffix), t[1] && (e += " — ")),
                                            t[1] && (this.prefix && (e += this.prefix), (e += this.getFormattedData(parseFloat(t[1]))), this.suffix && (e += this.suffix)),
                                            e
                                        );
                                    }
            ...
            datePicker: {
                init: function (t) {
                    var e = t.$input,
                        ...
                        s = Ee(
                            Ee({ dateFormat: "mm/dd/yy", firstDay: parseInt(a, 10) }, Te.datePicker.texts),
                            {},
                            {
                ...
                formatDate: function (t) {
                    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "mm/dd/yy",
                        ...
                        n = { monthNames: i.monthNames, monthNamesShort: i.monthNamesShort, dayNames: i.dayNames, dayNamesShort: i.dayNamesShort };
                ...
                parseDate: function (t) {
                    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "mm/dd/yy",
                        ...
                        i = Te.datePicker.texts,
                        n = { monthNames: i.monthNames, monthNamesShort: i.monthNamesShort, dayNames: i.dayNames, dayNamesShort: i.dayNamesShort },
                        o = { date: $e.datepicker.parseDate(e, t, Object.assign(n, r)), value: "" };
                    return (o.value = v(o.date) || ""), o;
                },
                get texts() {
            ...
            dateRange: {
                ...
                init: function (t) {
                    var e = t.id,
                        ...
                        v = { dateFormat: p, minDate: h, maxDate: y },
                        m = Te.datePicker.init({ $input: l, id: r, datepickerOptions: v }).on("change", function () {
                            var t = Te.datePicker.parseDate(l.val(), p),
                                e = Te.datePicker.parseDate(c.val(), p);
                            t.value || e.value ? a.val(t.value + "-" + e.value) : a.val(""), d && d("from", t.date), g.datepicker("option", "minDate", t.date || h);
                        }),
                        g = Te.datePicker.init({ $input: c, id: r, datepickerOptions: v }).on("change", function () {
                            var t = Te.datePicker.parseDate(l.val(), p),
                                e = Te.datePicker.parseDate(c.val(), p);
        ...
        var We = (function (t) {
                function e(t) {
                    ...
                    return (
                        ...
                        (i = r),
                        (o = "date-range"),
                        (n = Ke((n = "name"))) in i ? Object.defineProperty(i, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (i[n] = o),
                        r
                    );
                }
                return (
                        ...
                        (i = [
                            {
                                ...
                                value: function () {
                                    ...
                                    Re.dateRange.init({
                                        id:
                                            this.$filter.closest(".elementor-widget-jet-smart-filters-date-range").data("id") ||
                                            this.$filter.closest(".jet-sm-gb-wrapper").data("block-id") ||
                                            this.$filter.closest(".brxe-jet-smart-filters-date-range").attr("id"),
        ...
        function rr(t, e, r) {
            return (e = ir(e)) in t ? Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : (t[e] = r), t;
        }
        function ir(t) {
            var e = (function (t) {
        ...
        var nr = (function (t) {
            ...
            return (
                (function (t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), Object.defineProperty(t, "prototype", { writable: !1 }), e && er(t, e);
                })(e, t),
                (r = e),
                (i = [
                    {
                        ...
                        value: function () {
                            var t = this,
                                e = { language: "jsf", dateFormat: "yy/m/d", autoClose: !0, position: "bottom left", offset: 0, view: "days", minView: "days", firstDay: Number(d(JetSmartFilterSettings, "misc", "week_start")) };
                            if ((this.minDate && (e.minDate = this.minDate), this.maxDate && (e.maxDate = this.maxDate), !ze.fn.airDatepicker.language.jsf)) {
                                var r = d(JetSmartFilterSettings, "datePickerData");
                                ze.fn.airDatepicker.language.jsf = { days: r.dayNames, daysShort: r.dayNamesShort, daysMin: r.dayNamesMin, months: r.monthNames, monthsShort: r.monthNamesShort, today: r.currentText, clear: r.closeText };
                            }
                            (e.onSelect = function (e, r, i) {
                                if (r) {
                                    ...
                                    t.minDate && t.minDate > o && (o = t.minDate), t.maxDate && t.maxDate < n && (n = t.maxDate), t.$datepickerInput.val(v(o) + "-" + v(n)).trigger("change");
                                }
                            }),
                                (e.onShow = function (e) {
                                ...
                                (e.onRenderCell = function (e, r) {
                                    if ("week" === t.periodType && "day" === r && (t.debounceInitDatepickerWeekHover(), t.isDateInRange(e))) {
                                        var i = "-week-selected-";
                                        return t.isDateFirstInRange(e) && (i += " -week-start-selected-"), t.isDateLastInRange(e) && (i += " -week-end-selected-"), { classes: i };
                                    }
                                }),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (t && !(this.minDate && this.minDate >= t.date)) {
                                var e = m(t.date, -1),
                                    r = e;
                                "week" === this.periodType
                                    ? (r = m(e, -6))
                                    : "month" === this.periodType
                                    ? (r = new Date(e.getFullYear(), e.getMonth(), 1))
                                    : "year" === this.periodType
                                    ? (r = new Date(e.getFullYear(), 0, 1))
                                    : "range" === this.periodType && (r = m(new Date(e.getTime()), -this.periodCustomRange)),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return (
                                this.dateFormat &&
                                    (this.startEndDateEnabled ? (("start" !== e && e) || !this.dateFormat.start || (r = this.dateFormat.start), "end" === e && this.dateFormat.end && (r = this.dateFormat.end)) : (r = this.dateFormat)),
                                ...
                                mouseenter: function (r) {
                                    ...
                                    if (!(i < 0))
                                        for (var n = 0; n < 7; n++) {
                                            ...
                                            o.addClass("-week-hover-"), 0 === n && o.addClass("-week-start-hover-"), 6 === n && o.addClass("-week-end-hover-"), e.push(o);
                                        }
                                },
        ...
        var cr = (function (t) {
                function e(t) {
                    ...
                    return (
                        ...
                        (i = r),
                        (o = "radio"),
                        (n = ur((n = "name"))) in i ? Object.defineProperty(i, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (i[n] = o),
                        (r.mergeSameQueryKeys = !0),
                        (r.additionalFilterSettings = new It(r)),
                        (r.collapsibleList = new At(r)),
                        r
        ...
        var kr = (function (t) {
            function e(t) {
                ...
                return (
                    ...
                    (i = r),
                    (o = "rating"),
                    (n = jr((n = "name"))) in i ? Object.defineProperty(i, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (i[n] = o),
                    r
                );
            }
            return (
                (function (t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), Object.defineProperty(t, "prototype", { writable: !1 }), e && Sr(t, e);
                })(e, t),
                (r = e),
                Object.defineProperty(r, "prototype", { writable: !1 }),
                r
            ...
            (function (t) {
                function e(t, r, i) {
                    ...
                    return (
                        ...
                        (a = mr((a = "starsRatingSelector"))) in o ? Object.defineProperty(o, a, { value: s, enumerable: !0, configurable: !0, writable: !0 }) : (o[a] = s),
                ...
                return (
                    (function (t, e) {
                        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                        (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), Object.defineProperty(t, "prototype", { writable: !1 }), e && vr(t, e);
                    })(e, t),
                    (r = e),
                    (i = [
                        {
                            ...
                            value: function () {
                                ...
                                this.$starsRating.off("click"),
                                    this.$starsRating.on("click", function (e) {
                                        var r = fr(e.target);
                                        r.hasClass("is-checked") ? t.$starsRating.prop("checked", !1).removeClass("is-checked") : (t.$starsRating.removeClass("is-checked"), r.addClass("is-checked")), t.processData(), t.wasChanged();
                                    }),
        ...
        var $r = (function (t) {
            function e(t) {
                ...
                return (
                    ...
                    (i = r),
                    (o = "visual"),
                    (n = xr((n = "name"))) in i ? Object.defineProperty(i, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (i[n] = o),
                    (r.mergeSameQueryKeys = !0),
                    (r.additionalFilterSettings = new It(r)),
                    r
                );
            ...
            return (
                (function (t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), Object.defineProperty(t, "prototype", { writable: !1 }), e && Cr(t, e);
                })(e, t),
                (r = e),
                Object.defineProperty(r, "prototype", { writable: !1 }),
                r
        ...
        var Rr = (function (t) {
            function e(t) {
                ...
                return (
                    ...
                    (i = r),
                    (o = "alphabet"),
                    (n = Tr((n = "name"))) in i ? Object.defineProperty(i, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (i[n] = o),
                    r
                );
            }
            return (
                (function (t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), Object.defineProperty(t, "prototype", { writable: !1 }), e && Dr(t, e);
                })(e, t),
                (r = e),
                Object.defineProperty(r, "prototype", { writable: !1 }),
                r
        ...
        function Vr(t, e) {
            for (var r = 0; r < e.length; r++) {
                var i = e[r];
                (i.enumerable = i.enumerable || !1), (i.configurable = !0), "value" in i && (i.writable = !0), Object.defineProperty(t, Gr(i.key), i);
            }
        }
        function Br() {
            try {
        ...
        function Mr(t, e, r) {
            return (e = Gr(e)) in t ? Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : (t[e] = r), t;
        }
        function Gr(t) {
            var e = (function (t) {
        ...
        var zr = (function (t) {
            function e(t) {
                ...
                return (
                    ...
                    (i = r),
                    (o = "search"),
                    (n = Wr((n = "name"))) in i ? Object.defineProperty(i, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (i[n] = o),
                    r
                );
            }
            return (
                    ...
                    (n = [
                        {
                            ...
                            value: function () {
                                ...
                                this.$searchSubmit.on("click", function () {
                                    ...
                                    this.$searchClear.on("click", function () {
                                        t.$searchInput.val(""), t.$searchInput.removeClass(t.inputNotEmptyClass), t.wasChanged();
                                    }),
                                    this.$searchInput.on("keyup", function (r) {
                                        var i = r.target.value;
                                        i !== t.dataValue &&
                                            (e.publish("fiter/syncSameFilters", t),
                                            "ajax-ontyping" === t.applyType
                                                ? t.minLettersCount <= i.length
                                                    ? (t.emitFiterChangeWithDelay(), t.$searchInput.addClass(t.inputNotEmptyClass))
                                                    : (t.$searchInput.hasClass(t.inputNotEmptyClass) && t.emitFiterChangeWithDelay(), t.$searchInput.removeClass(t.inputNotEmptyClass))
                                                : 13 === r.keyCode && t.wasChanged());
                                    });
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.processData(),
                                    ((t = r),
                                    (e = this),
                                    "function" == typeof (i = qr(Nr(1 & 3 ? t.prototype : t), "wasChanged", e))
                                        ? function (t) {
                                              return i.apply(e, t);
                                          }
                            ...
                            value: function () {
                                ...
                                clearTimeout(this.delayID),
                                    (this.delayID = setTimeout(function () {
                                        t.$filter.addClass(t.searchLoadingClass), t.processData(), t.wasChanged();
                                    }, e));
                            },
                        },
                        {
        ...
        var ei = (function (t) {
            function e(t) {
                ...
                return (
                    ...
                    (i = r),
                    (o = "sorting"),
                    (n = ti((n = "name"))) in i ? Object.defineProperty(i, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (i[n] = o),
                    (r.mergeSameQueryKeys = !0),
                    r
                );
            }
        ...
        function ii(t, e) {
            for (var r = 0; r < e.length; r++) {
                var i = e[r];
                (i.enumerable = i.enumerable || !1), (i.configurable = !0), "value" in i && (i.writable = !0), Object.defineProperty(t, si(i.key), i);
            }
        }
        function ni() {
            try {
        ...
        var li = (function (t) {
            function r(t) {
                ...
                return (
                    ...
                    (n = i),
                    (a = "button-apply"),
                    (o = si((o = "name"))) in n ? Object.defineProperty(n, o, { value: a, enumerable: !0, configurable: !0, writable: !0 }) : (n[o] = a),
                    ...
                    e.subscribe("fiters/remove", function (t) {
                        i.filterGroup.isCurrentProvider(t) &&
                            setTimeout(function () {
                                i.updateState();
                            });
                    }),
                ...
                (n = [
                    {
                        ...
                        value: function () {
                            this.activeState &&
                                "always" !== this.activeState &&
                                (this.isActive
                                    ? "hide" === this.ifInactive
                                        ? this.$button.removeClass("jsf_hidden")
                                        : (this.$button.removeClass("jsf_disabled"), this.$button.prop("disabled", !1))
                                    : "hide" === this.ifInactive
                                    ? this.$button.addClass("jsf_hidden")
                                    : (this.$button.addClass("jsf_disabled"), this.$button.prop("disabled", !0)));
                        },
                    },
                    {
                        key: "isActive",
        ...
        var hi = (function (t) {
                function r(t) {
                    ...
                    var n,
                        o,
                        a,
                        s = t.find(".jet-remove-all-filters__button");
                    return (
                        (i = (function (t, e, r) {
                            return (
                                (e = fi(e)),
                        ...
                        (n = i),
                        (a = "button-remove"),
                        (o = pi((o = "name"))) in n ? Object.defineProperty(n, o, { value: a, enumerable: !0, configurable: !0, writable: !0 }) : (n[o] = a),
                        (i.$elementorWidget = i.$container.closest(".hide-widget")),
                        i.$filter.on("click", function () {
                            i.emitFitersRemove();
                        }),
                        e.subscribe("activeItems/change", function (t, e, r) {
                            (i.isCurrentProvider({ provider: e, queryId: r }) || i.isAdditionalProvider({ provider: e, queryId: r })) &&
                                (t.length ? (i.show(), i.$elementorWidget.removeClass("hide-widget")) : (i.hide(), i.$elementorWidget.addClass("hide-widget")));
                        }),
                        i
                    );
                }
        ...
        const mi = {
                init: function () {
                    var t = this;
                    (this.subscribers = []),
                        (this.preloaderTemplate = d(JetSmartFilterSettings, "plugin_settings", "provider_preloader")),
                ...
                subscribe: function (t, e) {
                    ...
                    i && this.subscribers.push({ target: t, provider: i, queryId: o, preloaderClass: s });
                },
                action: function (t, e) {
                    var r = this;
                    t.forEach(function (t) {
            ...
            return (
                ...
                (function (t, e) {
                    if (t) {
                        ...
                        var r = {}.toString.call(t).slice(8, -1);
                        return "Object" === r && t.constructor && (r = t.constructor.name), "Map" === r || "Set" === r ? Array.from(t) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? ji(t, e) : void 0;
                    }
                })(t) ||
                (function () {
                    throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
        ...
        function ki(t, e) {
            for (var r = 0; r < e.length; r++) {
                var i = e[r];
                (i.enumerable = i.enumerable || !1), (i.configurable = !0), "value" in i && (i.writable = !0), Object.defineProperty(t, xi(i.key), i);
            }
        }
        function Pi() {
            try {
        ...
        function Ci(t, e, r) {
            return (e = xi(e)) in t ? Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : (t[e] = r), t;
        }
        function xi(t) {
            var e = (function (t) {
                ...
                function r(t) {
                    ...
                    return (
                        ...
                        Ci(
                            ...
                            })(n, Pi() ? Reflect.construct(o, a || [], Oi(n).constructor) : o.apply(n, a)))),
                            "name",
                            "pagination"
                        ),
                        ...
                        (i.moreActiveIndexes = []),
                        (i.templates = d(JetSmartFilterSettings, "templates", "pagination") || {}),
                        void 0 !== i.controls.provider_top_offset && (i.topOffset = i.controls.provider_top_offset || 0),
                        i.buildPagination(),
                        mi.subscribe(t, { provider: i.provider, queryId: i.queryId }),
                        e.subscribe("ajaxFilters/end-loading", function (t, e) {
                            i.isCurrentProvider({ provider: t, queryId: e }) && i.update();
                        }),
                                ...
                                if (this.pagesCount < 2) this.$filter.html("");
                                    ...
                                    if (this.isItems)
                                        for (var i = 1; i <= this.pagesCount; i++)
                                            0 !== this.midSize && ((this.endSize < i && i < this.pageIndex - this.midSize) || (this.endSize <= this.pagesCount - i && i > this.pageIndex + this.midSize))
                                                ? r || (t.appendChild(this.buildDotsItem()), (r = !0))
                                                : (t.appendChild(this.buildPaginationItem("numeral", i, this.onPaginationItemClick.bind(this))), (r = !1));
                                    if (this.isNav) {
                                    ...
                                    this.isLoadMore && this.pageIndex < this.pagesCount && t.appendChild(this.buildLoadMore()), this.$filter.html(t), this.setCurrentItem(), e.publish("pagination/itemsBuilt", this);
                                }
                            },
                        },
                        {
                            ...
                            value: function (t, e, r) {
                                ...
                                return (
                                    (n.className = this.paginationItemClass),
                                    (n.innerHTML = i),
                                    "true" === d(JetSmartFilterSettings, "plugin_settings", "use_tabindex") && (n.tabIndex = 0),
                                    "prev" === t || "next" === t ? ((n.dataset.value = t), n.classList.add(this.navClass), n.classList.add(this[t + "Class"])) : (n.dataset.value = e),
                                    gi(n).on("click", r),
                                    n
                                );
                            },
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t,
                                    e = document.createElement("div");
                                return (
                                    (t = this.templates.load_more ? bi(this.templates.load_more, this.loadMoreText) : this.loadMoreText),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                if (!this.isAjaxLoading) {
                                    ...
                                    this.pageIndex === r || this.moreActiveIndexes.includes(r) || ((this.moreActiveIndexes = []), (this.dataValue = r), this.updateActivePagesProviderProps(), e.publish("pagination/change", this));
                                }
                            },
                        },
                        {
                            ...
                            value: function (t) {
                                if (!this.isAjaxLoading) {
                                    ...
                                    ++r <= this.pagesCount && (this.moreActiveIndexes.push(this.dataValue), (this.dataValue = r), this.updateActivePagesProviderProps(), e.publish("pagination/load-more", this));
                                }
                            },
                        },
                        {
                            ...
                            value: function () {
                                if (this.pageIndex) {
                                    var t = this.$filter.find("." + this.paginationListClass),
                                        e = [this.pageIndex]
                                            .concat(Si(this.moreActiveIndexes))
                                            .map(function (t) {
                                                return "[data-value='" + t + "']";
                                            })
                                            .join(", ");
            ...
            return (
                ...
                (function (t, e) {
                    if (t) {
                        ...
                        var r = {}.toString.call(t).slice(8, -1);
                        return "Object" === r && t.constructor && (r = t.constructor.name), "Map" === r || "Set" === r ? Array.from(t) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? Di(t, e) : void 0;
                    }
                })(t) ||
                (function () {
                    throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
        ...
        function Ti(t, e) {
            for (var r = 0; r < e.length; r++) {
                var i = e[r];
                (i.enumerable = i.enumerable || !1), (i.configurable = !0), "value" in i && (i.writable = !0), Object.defineProperty(t, Ri(i.key), i);
            }
        }
        function Ri(t) {
            var e = (function (t) {
            ...
            return (
                (t = function t(r) {
                    ...
                    !(function (t, e) {
                        ...
                        (i = this),
                        (o = {}),
                        (n = Ri((n = "activeItemsСollection"))) in i ? Object.defineProperty(i, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (i[n] = o);
                    ...
                    (this.$activeItemsContainer = r),
                        ...
                        e.subscribe("activeItems/change", function (t, e, r) {
                            a.isCurrentProvider({ provider: e, queryId: r }) && (a.addToCollection(t, e + "/" + r), a.buildItems());
                        }),
                        e.subscribe("activeItems/rebuild", function (t, e) {
                            a.isCurrentProvider({ provider: t, queryId: e }) && a.buildItems();
                        });
                }),
                (r = [
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (c(r)) return this.$activeItemsContainer.html(""), void this.$elementorWidget.addClass("hide-widget");
                            var i = document.createElement("div");
                            if (((i.className = this.listClass), this.filtersLabel)) {
                                var n = document.createElement("div");
                                (n.className = this.labelClass), (n.innerHTML = this.filtersLabel), i.appendChild(n);
                            }
                            this.clearItemLabel &&
                                i.appendChild(
                                    this.buildItem({
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var e = t.value,
                                ...
                                c = "";
                            s ? (i && s.label && (c += bi(s.label, i)), e && s.value && (c += bi(s.value, e)), s.remove && (c += s.remove)) : (c = e);
                            var f = document.createElement("div");
                            return (f.className = o), (f.innerHTML = c), "true" === d(JetSmartFilterSettings, "plugin_settings", "use_tabindex") && (f.tabIndex = 0), Ii(f).one("click", u), f;
                        },
                    },
                    {
                        key: "regularItem",
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            t.reset(r);
                            var i = t.copy;
                            (i.applyType = this.applyType), e.publish("fiter/change", i), e.publish("fiter/apply", i);
                        },
                    },
                    {
                        key: "setAllProviders",
                    ...
                    },
                    {
                        ...
                        get: function () {
                            var t = [];
                            for (var e in this.activeItemsСollection) t = [].concat(Ei(t), Ei(this.activeItemsСollection[e]));
                            return t;
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            for (var e = []; t.length; ) {
                                for (var r = void 0, i = t.shift(), n = i.filterId, o = 0; o < t.length; o++) {
                                    var a;
                                    t[o].filterId === n && (r || (r = [i]), (a = r).push.apply(a, Ei(t.splice(o, 1))), o--);
                                }
                                r ? e.push(r) : e.push(i);
                            }
                            return e;
            ...
            ActiveFilters: (function (t) {
                function e(t) {
                    ...
                    return (
                        ...
                        (function (t, e, r) {
                            (e = Li(e)) in t ? Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : (t[e] = r);
                        })(
                            ((i = this),
                            (o = [t, { templateName: "active_filter", listClass: "jet-active-filters__list", labelClass: "jet-active-filters__title", itemClass: "jet-active-filter" }]),
                            (n = qi((n = e))),
                            (r = (function (t, e) {
                            ...
                            })(i, Bi() ? Reflect.construct(n, o || [], qi(i).constructor) : n.apply(i, o)))),
                            "name",
                            "active-filters"
                        ),
                        r
                ...
                return (
                    (function (t, e) {
                        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                        (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), Object.defineProperty(t, "prototype", { writable: !1 }), e && Ni(t, e);
                    })(e, t),
                    (r = e),
                    Object.defineProperty(r, "prototype", { writable: !1 }),
                    r
            ...
            ActiveTags: (function (t) {
                function e(t) {
                    ...
                    return (
                        ...
                        (function (t, e, r) {
                            (e = Hi(e)) in t ? Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : (t[e] = r);
                        })(
                            ((i = this),
                            (o = [
                                t,
                                { separateMultiple: !0, templateName: "active_tag", listClass: "jet-active-tags__list", labelClass: "jet-active-tags__title", itemClass: "jet-active-tag", clearClass: "jet-active-tag jet-active-tag--clear" },
                            ]),
                            (n = Ji((n = e))),
                            (r = (function (t, e) {
                            ...
                            })(i, Gi() ? Reflect.construct(n, o || [], Ji(i).constructor) : n.apply(i, o)))),
                            "name",
                            "active-tags"
                        ),
                        r
        ...
        const zi = {
            ...
            eproPostRendered: function (t, e) {
                if ("epro-archive" === t || "epro-posts" === t) {
                    var r = this.defaultPostsClass,
                        i = null,
                        n = "posts";
                    "epro-archive" === t && ((r = this.archivePostsClass), (n = "archive-posts")),
                        (i = e.parent(r)),
                        this.fitImages(i),
            ...
            initMasonry: function (t) {
                var e,
                    ...
                    o = 1;
                switch ((i.css({ marginTop: "", transitionDuration: "" }), window.elementorFrontend.getCurrentDeviceMode())) {
                    case "mobile":
                ...
                if (((e = o >= 2), r.toggleClass("elementor-posts-masonry", e), e)) {
                    ...
                    a || (a = n[this.skin + "_item_gap"].size), new elementorModules.utils.Masonry({ container: r, items: i.filter(":visible"), columnsCount: o, verticalSpaceBetween: a }).run();
                } else r.height("");
            },
            fitImage: function (t) {
        ...
        var Qi = r(669),
            Yi = {
                ...
                filterClass: function (t) {
                    for (var e in Yi.filtersList) if ("jet-smart-filters-" + t === Yi.filtersList[e]) return e;
                },
                filters: Ki,
                filterNames: [],
                filterGroups: {},
                initFilter: function (t) {
                    if (!t.is("[jsf-filter]")) {
                        t.attr("jsf-filter", "");
                        var e = null;
                        for (var r in Yi.filtersList) t.hasClass(Yi.filtersList[r]) && (e = r);
                        if (e) {
                ...
                reinitFilters: function () {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
                    for (var e in (t && !Array.isArray(t) && (t = [t]), Yi.filterGroups)) Yi.filterGroups[e].reinitFilters(t);
                },
                ...
                setIndexedData: function (t) {
                    ...
                    if (Yi.filterGroups[t] && Yi.filterGroups[t].indexingFilters) {
                        var r = d(JetSmartFilterSettings, "ajaxurl"),
                            i = { action: "jet_smart_filters_get_indexed_data", provider: t, query_args: e, indexing_filters: Yi.filterGroups[t].indexingFilters };
                        Qi.ajax({ url: r, type: "POST", dataType: "json", data: i }).done(function (e) {
                            e.data &&
                                ...
                                Yi.filterGroups[t] &&
                                    Yi.filterGroups[t].filters.forEach(function (t) {
        ...
        function Zi(t) {
            var e, r, i;
            t.provider && t.queryId && ((e = t.provider), (r = t.queryId), (i = e + "/" + r), Yi.filterGroups[i] || (Yi.filterGroups[i] = new ct(e, r)), Yi.filterGroups[i]).addFilter(t);
        }
        function tn(t, e, r) {
            var i = {
                isAdditional: !0,
        ...
        Qi(document).ready(function () {
            ...
            document.dispatchEvent(t), window.elementorFrontend && zi.addSubscribers(), mi.init();
        ...
        var sn = r(669),
            ln = d(JetSmartFilterSettings, "seo", "selectors", "title"),
            ...
            pn = un && fn.length;
        function hn(t, e) {
            e || (e = t.data("fallback") || ""), t.html(e);
        }
        (dn || pn) && (JetSmartFilterSettings.extra_props.seo = { current_page: d(JetSmartFilterSettings, "seo", "current_page") }),
            ...
            e.subscribe("ajaxFilters/updated", function (t, e, r) {
                r.seo && (r.seo.hasOwnProperty("title") && dn && hn(cn, r.seo.title), r.seo.hasOwnProperty("description") && pn && hn(fn, r.seo.description));
            }),
            r(0),
            r(669)(document).on("jet-engine/listing/ajax-get-listing/done", function (t, e) {
                var r,
                    i = e.find(".jet-listing-grid__items");
                if (i.length) {
                    var n = "jet-engine",
                    ...
                    if (a) {
                        ...
                        if (s.length) {
                            var l = i.data("page"),
                                u = i.data("pages");
                            null !== (r = window.JetSmartFilterSettings.props) &&
                                void 0 !== r &&
                                null !== (r = r[n]) &&
                                void 0 !== r &&
                                r[o] &&
                                ((window.JetSmartFilterSettings.props[n][o].page = l),
            ...
            yn(window).on("elementor/frontend/init", function () {
                nn.filterNames.forEach(function (t) {
                    elementorFrontend.hooks.addAction("frontend/element_ready/jet-smart-filters-" + t + ".default", function (e) {
                        if (elementorFrontend.isEditMode()) an.initFilter(t, e);
                        else {
